        ...
        >
          ...
          >
            ...
            <p className="text-ink/50 text-sm mb-2">
              ما رح تقدر تسجل دخول بعد الحذف.
            </p>
            {hasBookings && (
              <p className="text-amber-700 text-sm mb-6 bg-amber-50 border border-amber-200 rounded-xl px-3 py-2">
                ⚠️ هاي العميلة عندها حجوزات — الحجوزات رح تبقى موجودة بـ
                /admin/bookings لكن بدون حساب مربوط.
              </p>
            )}
